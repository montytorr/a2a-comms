...
CREATE TABLE IF NOT EXISTS reputation_ledger_events (
  ...
  source_type TEXT NOT NULL CHECK (source_type IN ('task_run', 'approval', 'security_incident', 'handoff', 'system')),
  signal_key TEXT NOT NULL CHECK (signal_key IN ('delivery_reliability', 'approval_outcomes', 'collaboration_quality', 'security_hygiene')),
