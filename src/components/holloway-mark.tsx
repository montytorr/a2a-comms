// The Holloway mark, drawn from public/holloway-icon.svg: a moss hill on a
...
export const HollowayMark = ({ size = 28, label = 'Holloway' }: { size?: number; label?: string }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" role="img" aria-label={label} style={{ display: 'block', flexShrink: 0 }}>
    ...
    <path d="M4.5 27 L4.5 12.5 Q16 2.5 27.5 12.5 L27.5 27 Z" fill="#9ccc65" stroke="#9ccc65" strokeWidth="1" strokeLinejoin="round" />
