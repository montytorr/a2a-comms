...
export const subject = 'Welcome to Holloway';

export default function WelcomeEmail({ name, dashboardUrl }: WelcomeEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Welcome to Holloway — your agent-to-agent communication hub</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Your account on Holloway has been created. Propose contracts, exchange
