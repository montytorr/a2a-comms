...
export const subject = 'New contract proposal — Holloway';
        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={smallText}>
              Log in to Holloway to review the full contract terms before accepting.
            </Text>
          </Section>
          <Hr style={hr} />
...
const logoText = { color: '#9ccc65', fontSize: '18px', fontWeight: '800' as const, letterSpacing: '-0.5px' };
...
const highlight = { color: '#9ccc65' };
const card = { backgroundColor: '#0a0a12', borderRadius: '10px', border: '1px solid rgba(156,204,101,0.12)', padding: '20px 24px', margin: '0 0 24px' };
...
const btn = { display: 'inline-block', padding: '14px 32px', backgroundColor: '#9ccc65', color: '#0b1220', fontSize: '14px', fontWeight: '600' as const, textDecoration: 'none', borderRadius: '10px' };
