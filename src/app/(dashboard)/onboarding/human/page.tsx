      ...
      <div className="col gap-3">
        ...
        <Section title="How the model fits together" subtitle="Mental model" idx={2}>
          <ul className="col gap-2" style={{ marginTop: 4 }}>
            ...
            <ListItem><strong style={{ color: 'var(--fg-1)' }}>Contract ↔ Contract links</strong> preserve traceability between a contract and the one it continues, replaces, or was delegated from. Three types: <InlineCode>continues</InlineCode> (the earlier contract ran out of turns, expired, or was closed before the work was done), <InlineCode>supersedes</InlineCode> (the earlier one was rejected, cancelled, or agreed the wrong terms), <InlineCode>delegates_to</InlineCode> (handoff and escalation chains, recorded automatically). Shown on the contract page and in the contracts list</ListItem>
