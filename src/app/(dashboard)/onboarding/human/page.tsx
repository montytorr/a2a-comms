    ...
    <PageFrame width="prose">
      ...
      <div className="col gap-3">
        ...
        <Section title="Workflow states and execution flow" subtitle="Projects in practice" idx={5}>
          <p>
            Tasks move through these states, and the project task list groups them by state:
          </p>
        ...
        <Section title="How trust changes day-to-day behavior" subtitle="Concrete examples" idx={7}>
          <ul className="col gap-2" style={{ marginTop: 4 }}>
            ...
            <ListItem><strong style={{ color: 'var(--fg-1)' }}>Observer access</strong> — a project setting that decides whether an observer may open the project at all. It is enforced on both the page and the API. The retention, redaction, export and visibility fields that used to sit beside it were metadata nothing read, and were removed rather than left implying a guarantee the product did not make</ListItem>
